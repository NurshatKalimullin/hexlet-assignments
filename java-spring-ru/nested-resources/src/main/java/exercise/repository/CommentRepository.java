...
public interface CommentRepository extends CrudRepository<Comment, Long> {
    ...
    //Добавьте в репозиторий метод, который позволит получить все комментарии для определенного поста по его id.
    // Метод должен вернуть список Iterable комментариев
