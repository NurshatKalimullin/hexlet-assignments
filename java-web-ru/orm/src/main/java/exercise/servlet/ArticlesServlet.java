...
public class ArticlesServlet extends HttpServlet {
    ...
    private void showArticles(HttpServletRequest request,
        ...
        // BEGIN
        PagedList<Article> pagedList = DB.find(Article.class)
                .order().asc("id")
                .setFirstRow(offset)
    ...
    private void showArticle(HttpServletRequest request,
        ...
        Article article = new QArticle()
                .id.equalTo(id) // Ищем совпадение по id
                .findOne();
    ...
    private void createArticle(HttpServletRequest request,
        ...
        Category category = new QCategory()
                .id.equalTo(Integer.parseInt(categoryId)) // Ищем совпадение по id
                .findOne();
        // Создаём новый экземпляр модели
        Article customer = new Article(title, body, category);
